// Banka yazışma sayı no üretme API - FIRMA-YY/MUHATAP.SIRA formatı (örn: KAD-26/DSİ.001)
...
export async function POST(request: Request) {
  ...
  // Format: KAD-26/DSİ.001 (giden evrak ile aynı format)

...
# Bildirge senkronu 2 DAKIKADA bir: artimli okuma sayesinde (bkz. bildirge_imap_durum)
# her tur yalnizca yeni gelen mailleri indiriyor. Kalan maliyet IMAP giris/cikisi;
# normal bir masaustu mail programinin yoklama sikligiyla ayni mertebede.
Kur 'Personel Bildirge Sync' (Act 'personel-bildirge-gizli.vbs') (Rep 2) $prinS4U $setPers

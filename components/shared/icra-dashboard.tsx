...
// Eski tarihli (en uzun bekleyen) üstte; cevap verilince listeden düşer.
"use client";
...
export default function IcraDashboard() {
  ...
  // İcraya cevabı verilmemiş = İcraya Cevap Tarihi boş. En eski (en uzun bekleyen) üstte.
      ...
      {loading ? (
        ...
        <div className="max-h-[220px] overflow-y-auto">
          <Table className="text-xs">
            ...
            <TableBody>
              {bekleyen.map((s) => (
                <TableRow key={s.id} className="cursor-pointer hover:bg-red-50" onClick={() => { window.location.href = `/dashboard/icra?duzenle=${s.id}`; }}>

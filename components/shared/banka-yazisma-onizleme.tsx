// Banka yazışma ön izleme — Dilekçe Standart Sayfa Formatı
"use client";
...
export default function BankaYazismaOnIzleme({
  firma, evrakTarihi, evrakSayiNo, konu, muhatap, ilgiListesi, metin, ekler, kaseDahil,
}: Props) {
  ...
  return (
    <div className="evrak-onizleme bg-white mx-auto" style={{
      ...
      {/* Sayı */}
      {evrakSayiNo && (
        <div style={{ fontSize: "10.5pt", marginBottom: "0.2cm", textIndent: "0cm" }}>
      ...
      {/* Konu */}
      <div style={{ fontSize: "10.5pt", textAlign: "left", textIndent: "0cm" }}>
